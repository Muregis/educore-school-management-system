    ...
    return (
      <div style={{ display: "grid", gap: "var(--space-4)" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "var(--space-3)" }}>
          {cards.map(x => (
            <Card key={x[0]}>
              <div style={{ color: "var(--color-text-muted)", fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 700 }}>{x[0]}</div>
              <div style={{ color: "var(--color-text-primary)", fontWeight: 800, fontSize: "28px", marginTop: "var(--space-2)" }}>{x[1]}</div>
            </Card>
          ))}
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "var(--space-3)", alignItems: "start" }}>
          <Card>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, marginBottom: "var(--space-4)", fontFamily: "var(--font-heading)" }}>Attendance Trend (Last 7 Days)</div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", alignItems: "end", gap: 8, minHeight: 120 }}>
          ...
          <Card>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, marginBottom: "var(--space-4)", fontFamily: "var(--font-heading)" }}>Grade Distribution</div>
            {["EE", "ME", "AE", "BE"].map(g => (
      ...
      <div style={{ display: "grid", gap: "var(--space-4)" }}>
        ...
        <Card>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--space-4)" }}>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, fontFamily: "var(--font-heading)" }}>Pending Lesson Plans</div>
  ...
  if (auth?.role === "teacher") {
    ...
    return (
      <div style={{ display: "grid", gap: "var(--space-4)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "var(--space-3)", alignItems: "start" }}>
          <Card>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, marginBottom: "var(--space-4)", fontFamily: "var(--font-heading)" }}>My Classes Attendance (Last 7 Days)</div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", alignItems: "end", gap: 8, minHeight: 120 }}>
              {attendanceByDate.length === 0 ? (
          ...
          <Card>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, marginBottom: "var(--space-4)", fontFamily: "var(--font-heading)" }}>My Students Grade Distribution</div>
            {["EE", "ME", "AE", "BE"].map(g => (
              <div key={g} style={{ marginBottom: "var(--space-3)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "12px", color: "var(--color-text-secondary)", marginBottom: "4px" }}>
                  <span style={{ fontWeight: 600 }}>{g}</span>
        ...
        <Card>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "var(--space-4)" }}>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, fontFamily: "var(--font-heading)" }}>My Lesson Plans</div>
    ...
    return (
      <div style={{ display: "grid", gap: "var(--space-4)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-3)", alignItems: "start" }}>
          <Card>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, marginBottom: "var(--space-4)", fontFamily: "var(--font-heading)" }}>Recent Payments</div>
            <div style={{ fontSize: "13px", maxHeight: "250px", overflowY: "auto", paddingRight: "var(--space-2)" }}>
          ...
          <Card>
            <div style={{ color: "var(--color-text-primary)", fontWeight: 700, marginBottom: "var(--space-4)", fontFamily: "var(--font-heading)" }}>Outstanding by Class</div>
