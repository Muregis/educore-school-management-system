        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "var(--space-3)" }}>
          {[
            ...
            <Card key={label} style={{ position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ color: "var(--color-text-primary)", fontWeight: 800, fontSize: "clamp(15px, 2.2vw, 26px)", marginTop: "var(--space-2)", wordBreak: "break-all", lineHeight: 1.2 }}>{value}</div>
            </Card>
          ))}
        </div>
