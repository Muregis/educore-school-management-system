      ...
      {tab === "staff" && (
        <div>
          <div style={{ display:"flex", gap:8, marginBottom:12, flexWrap:"wrap" }}>
            ...
            {canEdit && <Btn tone="secondary" size="sm" onClick={async () => { try { const res = await apiFetch("/hr/sync-teachers", { method:"POST", token:auth.token }); toast(`Synced ${res.synced} teachers`, "success"); } catch (e) { toast(e.message || "Sync failed", "error"); console.error("Teacher sync error:", e); } }}>🔄 Sync to Teachers</Btn>}
