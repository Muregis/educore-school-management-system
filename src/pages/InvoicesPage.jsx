...
export default function InvoicesPage({ auth, school, students, canEdit, toast }) {
  ...
  const printInvoice = (inv) => {
    ...
    const html = `
      <div class="print-document">
        ...
        <div class="print-header">
          ...
          <div class="print-header-title">Fee Invoice — ${inv.term} ${inv.academic_year}</div>
        ...
        <style>
          ...
          .total{font-weight:bold;font-size:16px;border-top:2px solid #1f2937;margin-top:8px;padding-top:8px}
          .invoice-footer{margin-top:40px;text-align:center;color:#6b7280;font-size:12px}
          @media print{
    ...
    printHTML(html, { title: `Invoice ${inv.invoice_number}` });
  };
