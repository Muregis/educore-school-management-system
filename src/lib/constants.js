...
export const DEFAULTS = {
  ...
  results: [],
  feeStructures: [
    { id: 1, className: "Grade 6", tuition: 15000, activity: 2000, misc: 500 },
    { id: 2, className: "Grade 7", tuition: 16000, activity: 2000, misc: 500 },
    { id: 3, className: "Grade 8", tuition: 17000, activity: 2000, misc: 500 },
  ],
  payments: [],
  notifications: [],
};
...
export const ROLE = {
  admin: { pages: ["dashboard", "students", "teachers", "attendance", "grades", "fees", "settings"], edit: true },
  teacher: { pages: ["dashboard", "students", "attendance", "grades"], edit: true },
  viewer: { pages: ["dashboard", "students", "teachers", "attendance", "grades", "fees"], edit: false },
};
