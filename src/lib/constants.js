...
export const DEFAULTS = {
  ...
  users: [
    { id: 1, name: "Mrs. Wanjiku",       email: "admin@greenfield.ac.ke",   password: "admin123",   role: "admin",   status: "active", studentId: null },
    { id: 2, name: "Grace Akinyi",       email: "teacher@greenfield.ac.ke", password: "teacher123", role: "teacher", status: "active", studentId: null },
    { id: 3, name: "Mr. Osei (Parent)",  admission: "ADM-2020-001",         password: "parent123",  role: "parent",  status: "active", studentId: 1 },
    { id: 4, name: "Amara Osei",         admission: "ADM-2020-001",         password: "student123", role: "student", status: "active", studentId: 1 },
    { id: 5, name: "Brian Kamau",        admission: "ADM-2019-002",         password: "student123", role: "student", status: "active", studentId: 2 },
    { id: 6, name: "Chloe Mutua",        admission: "ADM-2021-003",         password: "student123", role: "student", status: "active", studentId: 3 },
  ],
  students: [
    ...
    { id: 4, admission: "ADM-2022-004", firstName: "Kevin", lastName: "Osei",  className: "Grade 5", gender: "male",   parentName: "Mr. Osei",   parentPhone: "0712345678", dob: "2014-06-10", status: "active" },
  ],
  teachers: [
  ...
  feeStructures: [
    ...
    { id: 3, className: "Grade 7", term: "Term 2", tuition: 16000, activity: 2000, misc: 500 },
    { id: 4, className: "Grade 8", term: "Term 2", tuition: 17000, activity: 2000, misc: 500 },
  ],
};
