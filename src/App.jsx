...
export default function App() {
  ...
  const canManageDiscounts = ["director", "superadmin"].includes(auth?.role); // Only director/superadmin can apply discounts
