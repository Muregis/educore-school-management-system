...
import CollegeUnitsPage from "./pages/CollegeUnitsPage";
import CollegeEnrollmentsPage from "./pages/CollegeEnrollmentsPage";
...
const fullNav = useMemo(() => {
  ...
  const pages = {
    ...
    students: <StudentsPage auth={auth} school={school} students={students} setStudents={setStudents} canEdit={canEdit} results={results} payments={payments} feeStructures={feeStructures} toast={toast} />,
    ...
    attendance: isPortal && isMobile ? (() => { setPage("dashboard"); return null; })() : <AttendancePage auth={auth} school={school} students={myStudents} attendance={myAttendance} setAttendance={setAttendance} canEdit={canEdit} toast={toast} linkedStudentId={linkedStudentId} feeBlocked={isParent && (auth?.feeBlocked ?? false)} onGoFees={() => setPage("fees")} />,
