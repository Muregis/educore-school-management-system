...
export const env = {
  ...
  fetTimetableJwtSecret: clean(process.env.FET_TIMETABLE_JWT_SECRET) || clean(process.env.JWT_SECRET) || "educore_dev_secret_change_me",
  fetTimetableBaseUrl:   clean(process.env.FET_TIMETABLE_BASE_URL) || "/fet-timetable",
  fetTimetableJwtExpiresIn: process.env.FET_TIMETABLE_JWT_EXPIRES_IN || "2m",
